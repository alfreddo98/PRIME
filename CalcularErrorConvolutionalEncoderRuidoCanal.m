function BER = CalcularErrorConvolutionalEncoderRuidoCanal(signal, Nf, NFFT, M ,Nofdm, tx_bits, enrejado, ruido, canal, piloto)
% Función: Función que recibe la señal transmitida y la recibida,
% demodulada la recibida, las compará y devuelve el BER de la transmisión. En
...
% desentralazado, dealeatorización y decodificación.  Se añade además el canal indicado en el enunciado. Se le
