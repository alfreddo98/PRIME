function [tx_bits, signal, piloto_ecualizador] = ModulacionConvolutionalEncoderPC(M, Nf, NFFT, Nofdm, enrejado)
...
% aleatoriza ese vector, una parte en la que se añade el prefijo cíclico ,una parte en la que se realiza el entrelazado y un codificador convolucional que además cambiará el número de bits transmitidos.
...
% trama para la modulación OFDM, especificado en el standard también. enrejado= resultado de la función polytrellis que funciona como registro
% de desplazamiento.
